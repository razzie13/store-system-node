...
router.post("/webstore-departments",(function(req,res){
        ...
        res.render(__dirname + '/webstore-departments', { data, jumpToDepartmentButton });
...
router.post("/webstore-search",(function(req,res){
        ...
        res.render(__dirname + '/store-data-search.ejs', { response, itemCodeFormField, itemCategoryFormField, itemDescriptionFormField });
